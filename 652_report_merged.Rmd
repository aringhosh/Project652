...
lookup = data.frame(HUIGHER=levels(hui$HUIGHER), 
                    hearingState=c('Good', 'Good', 'Bad','Bad'))
...
$$ \log \left( \frac{p(X)}{1-p(X)} \right) = \beta_0 + X_1 \beta_1 + \ldots + X_p \beta_p $$
...
```{r, echo=F}
lookup = data.frame(t(c(0.02541022, 0.02662107, 0.04187508)))
